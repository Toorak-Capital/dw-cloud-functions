...
def opr_emailer(file_name, sdk, email_api, bucket, get_bucket):
    ...
    body_ = """<html>
        ...
        Please find below the link to report name.<br>Please let us know if you face any issues.<br>
        <ul>
            <li><a href="https://toorakcapital.cloud.looker.com/dashboards/189">Looker Report</a></li>
            <li><a href="https://toorakcapital.app.box.com/s/l37hd2as5nwsdcx7t3sqqa7po8gsclso">Box Folder</a></li>
        </ul>
